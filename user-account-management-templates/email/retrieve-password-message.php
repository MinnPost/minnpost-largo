...
@media only screen and (max-width: 600px) {
	...
	<span style="display: none !important; font-size: 0; color: #fff;"> <!-- gmail only takes display none if it has !important; outlook still doesn't care -->
		Use the link in this email to set a new password.
	</span>
											...
											<table cellpadding="0" cellspacing="0" class="contents" style="border-spacing: 0; margin: 0; padding: 0; font-family: Helvetica, Arial, Geneva, sans-serif; color: #1a1818; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; width: 100%; font-size: 16px; text-align: left;">
												<tr>
													<td style="border-collapse: collapse; margin: 0; padding: 0; max-height: 90px; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0; line-height: 0px;" valign="bottom">
														<a href="https://www.minnpost.com/" style="color: #1A1818; text-decoration: none;"><img src="https://www.minnpost.com/wp-content/uploads/sites/default/themes/siteskin/inc/images/newsletter-logo-daily.png" alt="MinnPost" width="390" height="90" align="left" style="height: auto; margin: 0; padding: 0; border: 0 none; line-height: 100%; outline: none; text-decoration: none; width: 100%; max-width: 390px; max-height: 90px; display: block; vertical-align: bottom;" /></a>
													</td>
												</tr>
											</table>
										</td>
						...
						<![endif]-->
							<div class="column story story-first">
									<div class="story-inner" style="border-bottom-width: 2px; border-bottom-color: #cccccf; border-bottom-style: solid; padding-bottom: 18px; margin-bottom: 18px; margin-top: 18px;">
										<h3 style="color: #1a1818; margin: 0 0 10px; padding: 0; display: block; font-weight: bold; line-height: 1.05; font-family: Helvetica, Arial, Geneva, sans-serif; font-size: 22px;" align="left">We received a request to reset your password</h3>
										<table cellpadding="0" cellspacing="0" class="bodyTable" style="border-spacing: 0; margin: 0; padding: 0; font-family: Helvetica, Arial, Geneva, sans-serif; color: #1a1818; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; text-align: left;">
											<tr>
												<td valign="top" style="border-collapse: collapse; margin: 0; padding: 0;">
													<div>
														<p style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 16px; line-height: 20.787px; margin: 0 0 10px; padding: 0;">Use the link below to set up a new password for your MinnPost.com account. If you did not request to reset your password, ignore the email and the link will expire on its own.</p>
															...
															<tr>
																<td style="border-collapse: collapse; margin: 0; padding: 0;">
																	<table cellpadding="0" cellspacing="0" style="border-spacing: 0; margin: 0; padding: 0; font-family: Helvetica, Arial, Geneva, sans-serif; color: #1a1818; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse;">
																		<tr>
																			<td align="center" style="border-collapse: collapse; -webkit-border-radius: 2px; -moz-border-radius: 2px; border-radius: 2px; margin: 0; padding: 0;" bgcolor="#801019"><a href="<?php echo $attributes['reset_url']; ?>" target="_blank" style="color: #ffffff; padding: 8px 12px; border: 1px solid #801019; text-decoration: none; font-family: Georgia, 'Times New Roman', Times, serif; font-size: 16px; -webkit-border-radius: 2px; -moz-border-radius: 2px; border-radius: 2px; display: inline-block;"><!--[if mso]>&nbsp;<![endif]-->Set your new password<!--[if mso]>&nbsp;<![endif]--></a></td>
																		</tr>
																	</table>
																</td>
															</tr>
