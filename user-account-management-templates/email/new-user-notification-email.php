											...
											<tr>
												<td valign="top" style="border-collapse: collapse; margin: 0; padding: 0;">
													<div>
														...
														<p style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 16px; line-height: 20.787px; margin: 0 0 10px; padding: 0;">If you have not set up your preferences yet, you can <a href="#" style="color: #801019; text-decoration: none;">do that now</a>.</p>
