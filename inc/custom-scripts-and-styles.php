...
if ( ! function_exists( 'minnpost_largo_load_custom_styles' ) ) :
	add_action( 'wp_enqueue_scripts', 'minnpost_largo_load_custom_styles' );
	function minnpost_largo_load_custom_styles() {
...
if ( ! function_exists( 'minnpost_largo_remove_scripts' ) && ! function_exists( 'minnpost_largo_remove_styles' ) ) :
	...
	add_action( 'wp_enqueue_scripts', 'minnpost_largo_remove_styles', 10 );
