...
*/
if ( ! function_exists( 'post_has_meta_value' ) ) :
	function post_has_meta_value( $current_post, $params ) {
		$has_meta_value = false;
		$has_meta_value = has_meta_value( 'get_post_meta', $current_post, $params );
...
* @return bool $has_meta_value
*/
if ( ! function_exists( 'user_has_meta_value' ) ) :
	function user_has_meta_value( $current_user, $params ) {
		$has_meta_value = false;
		$has_meta_value = has_meta_value( 'get_user_meta', $current_user, $params );
		return $has_meta_value;
	}
endif;
...
* @return bool $has_meta_value
*/
if ( ! function_exists( 'has_meta_value' ) ) :
	function has_meta_value( $method, $current_id, $params ) {
		$has_meta_value = false;
		if ( ! is_array( $params ) ) {
