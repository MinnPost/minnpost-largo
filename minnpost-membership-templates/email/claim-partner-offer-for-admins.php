										...
										<table cellpadding="0" cellspacing="0" class="bodyTable" style="border-spacing: 0; margin: 0; padding: 0; font-family: Helvetica, Arial, Geneva, sans-serif; color: #1a1818; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; text-align: left;">
											<tr>
												<td valign="top" style="border-collapse: collapse; margin: 0; padding: 0;">
													<div>
														<p style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 16px; line-height: 20.787px; margin: 0 0 10px; padding: 0;">One of the open partner offers has just been claimed.</p>

														<p style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 16px; line-height: 20.787px; margin: 0 0 10px; padding: 0;">- Offer title: <?php echo $attributes['partner_offer']->post_title; ?></p>

														<p style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 16px; line-height: 20.787px; margin: 0 0 10px; padding: 0;">- Claimed instance number: <?php echo $attributes['instance_id']; ?></p>
														...
														<p style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 16px; line-height: 20.787px; margin: 0 0 10px; padding: 0;">- Claiming user edit link: <a href="<?php echo admin_url( 'post.php?post=' . $attributes['partner_offer']->instances[ $attributes['instance_id'] ]['_mp_partner_offer_claim_user']['id'] . '&action=edit' ); ?>"><?php echo admin_url( 'post.php?post=' . $attributes['partner_offer']->instances[ $attributes['instance_id'] ]['_mp_partner_offer_claim_user']['id'] . '&action=edit' ); ?></a></p>
